...
class ExtractPivotedFeatures(BaseTask):
  ...
  def execute_query(self):
    ...
    print("====================Finished Extracting Pivoted Features====================\n")
